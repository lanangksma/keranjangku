<div class="bg-white text-gray-700 w-full sm:w-72 min-h-[10rem] shadow-lg rounded-md overflow-hidden dark:bg-gray-700 xl:scale-95 hover:shadow-2xl hover:scale-90 transition duration-300">
    {{ $img }}
